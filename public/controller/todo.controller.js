...
const todo_models_js_1 = require("../models/todo.models.js");
const createTodo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var todos = yield todo_models_js_1.Todos.create(Object.assign({}, req.body));
    return res
        .status(200)
...
const deleteToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const deleteToDo = yield todo_models_js_1.Todos.findByPk(id);
    yield todo_models_js_1.Todos.destroy({ where: { id } });
    return res
        .status(200)
...
const getAllToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const allTodos = yield todo_models_js_1.Todos.findAll();
    return res
        .status(200)
...
const getTodoById = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const todos = yield todo_models_js_1.Todos.findByPk(id);
    return res
        .status(200)
...
const updateToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield todo_models_js_1.Todos.update(Object.assign({}, req.body), { where: { id } });
    const updatedTodos = yield todo_models_js_1.Todos.findByPk(id);
    return res
        .status(200)
